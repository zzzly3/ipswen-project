...
#ifdef HAVE_IPSWEN
#define BGP_AF_IPSWEN BGP_AF( BGP_AFI_IPV4, BGP_SAFI_IPSWEN )  /* We treat ipswen addresses as a sub-family of AF_IPV4. */
#endif
...
struct bgp_proto {
  ...
  u8 ipswen_extension;  /* Session uses ipswen extension in UPDATEs. (Experimental. Both sides support it.) */
