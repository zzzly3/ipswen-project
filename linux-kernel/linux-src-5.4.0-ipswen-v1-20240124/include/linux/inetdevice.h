...
struct in_ifaddr {
	...
	struct ipswen_addr	ifa_local;
	struct ipswen_addr	ifa_address;
	struct ipswen_addr	ifa_mask;
	struct ipswen_addr	ifa_broadcast;
#else
	__be32			ifa_local;
	__be32			ifa_address;
	__be32			ifa_mask;
...
{
	return !((addr ^ ifa->ifa_address.base) & ifa->ifa_mask.base);
}
